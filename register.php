...
<body>
    <div class="register-container">
        ...
        <div class="register-body">
            ...
            <form action="/student-tutoring/register.php" method="post" enctype="multipart/form-data">
                ...
                <form action="/student-tutoring/register.php" method="post">
                    <div class="form-group">
