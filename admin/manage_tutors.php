...
// fetch tutor
$stmt = $conn->prepare("SELECT * FROM tbl_tutor WHERE is_verified = 1");
$stmt->execute();
...
<head>
    ...
    <link rel="stylesheet" href="css/manage_tutors.css">
</head>
        ...
        <div class="sidebar">
            ...
            <div class="sidebar-menu">
                ...
                <ul>
                    ...
                    <li><a href="manage_tutors.php" class="active" data-tab=" tutors"><i class="fas fa-chalkboard-teacher"></i> Tutors</a></li>
        ...
        <div class="main-content">
            ...
            <div class="tab-container">
                <div class="tabs">
                    ...
                    <div class="tab active" data-tab="tutors" onclick="window.location.href = 'manage_tutors.php'">
            ...
            <div class="card">
                <div class="card-header">
                    <h3>Approved Tutors Application</h3>
                </div>
                    ...
                    <tbody>
                        <?php foreach ($tutors as $tutor): ?>
                            <tr>
                                ...
                                <td>
                                    <?= $tutor['is_verified'] == 1 ? 'Approved' : 'Pending' ?>
                                </td>
                                <td>
                                    <form method="post" style="display: inline;">
                                        <input type="hidden" name="tutor_id" value="<?= $tutor['id'] ?>">
                                        <button type="submit" name="delete_tutor" class="btn btn-danger">Delete</button>
                                    </form>
                                </td>
                            </tr>
                        <?php endforeach; ?>
