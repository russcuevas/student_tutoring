...
$stmt = $conn->prepare("SELECT * FROM tbl_users WHERE is_verified = 1");
$stmt->execute();
        ...
        <div class="sidebar">
            ...
            <div class="sidebar-menu">
                ...
                <ul>
                    ...
                    <li><a href="manage_students.php" class="active" data-tab="users"><i class="fas fa-users"></i> Users</a></li>
        ...
        <div class="main-content">
            ...
            <div class="tab-container">
                <div class="tabs">
                    ...
                    <div class="tab active" data-tab="users" onclick="window.location.href = 'manage_students.php'">Users (<?= $approved_student_count ?>)</div>
            ...
            <div class="card">
                <div class="card-header">
                    <h3>Approved Student Application</h3>
                </div>
                <table>
                    <thead>
                        <tr>
                    ...
                    <tbody>
                        <?php foreach ($students as $student): ?>
                            <tr>
                                ...
                                <td>
                                    <?= $student['is_verified'] == 1 ? 'Approved' : 'Pending' ?>
                                </td>
                                <td>
